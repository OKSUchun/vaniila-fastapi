...
# LOADIT DB 요청 실패
class LOADITDBRequestFailException(Exception):
    def __init__(self, error_object):
        self.error_object = error_object

        # DB 오류시 기본 응답 코드
        self.response_code = "DB_ERROR"
        self.response_message = "LOADIT DB 요청에 실패했습니다."
        ...
        if isinstance(error_object, mysqlError):
            ...
            if error_object.errno == 1062:
                ...
                self.response_content = { "code": "self.response_code", "message": self.response_message}
